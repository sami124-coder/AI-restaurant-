...
import { Bot, Send, Sparkles, TrendingUp, Package, Utensils, LogOut, ShieldCheck, CircleDollarSign, Database, Upload, X } from "lucide-react";
import "./styles.css";
import "./decision.css";
...
function Root() {
  ...
  return <>{authenticated&&<button className="data-fab" onClick={()=>setShowData(true)}><Database/> Connect real data</button>}{showData&&<DataPanel onClose={()=>setShowData(false)} onImported={()=>{}}/>}<App/></>;
}
